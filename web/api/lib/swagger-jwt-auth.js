...
//		    alert('Second:'+token);
                    ...
                    if (!token) {
                        cb(new Error('JWT auth error: Unable to find token from the response with property name: ' + this.tokenPropertyName));
                    }
